...
#[Route('/dashboard')]
class ProjectControllerNew extends AbstractController
{
    ...
    #[Route('/project/create', name: 'api_project_create_new', methods: ['POST'])]
    public function createProject(Request $request): JsonResponse
    {
        ...
        try {
            $project = $this->projectService->createProject($user, $data['title']);
    ...
    #[Route('/project/{id}/toggle-pin', name: 'api_project_toggle_pin_new', methods: ['POST'])]
